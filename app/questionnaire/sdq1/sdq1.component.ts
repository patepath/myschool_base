...
@Component({
  selector: 'app-sdq1',
  templateUrl: './sdq1.component.html',
  styleUrls: ['./sdq1.component.css']
})
export class Sdq1Component implements OnInit {
    ...
    if(this.sdq.Code.length >= 5) {
      ...
      this.studentServ.getByCode(this.sdq.Code).subscribe(
        student => {
          ...
          this.sdqServ.getbycode(this.sdq.Code, 1).subscribe(
            sdq => {
              this.sdq = sdq;
